...
define('DB_HOSTNAME', 'us-cdbr-iron-east-04.cleardb.net');
define('DB_USERNAME', 'bef8e19ac0c07c');
define('DB_PASSWORD', '5a79c2c9');
define('DB_DATABASE', 'heroku_e5a7ce05d01ad5f');
define('DB_PORT', '3306');
